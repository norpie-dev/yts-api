...
def main():
    print("Testing start")
    print(movie_details("10"))
    print("Testing end")

# List Movies - https://yts.mx/api#list_movies
def list_movies(limit="20", page="0", quality="1080p", minimum_rating="0", query_term="0", genre="All", sort_by="date_added", order_by="desc", with_rt_ratings="false"):
